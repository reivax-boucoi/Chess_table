...
//endXB
  ...
  #define Y_STEP_BIT      4 //XB  // Uno Digital Pin 3
  #define Z_STEP_BIT      6 //XB  // Uno Digital Pin 4
  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits

  // Define step direction output pins. NOTE: All direction pins must be on the same port.
  #define DIRECTION_DDR     DDRD
  #define DIRECTION_PORT    PORTD
  #define X_DIRECTION_BIT   3 //XB  // Uno Digital Pin 5
  #define Y_DIRECTION_BIT   5 //XB  // Uno Digital Pin 6
  ...
  #define CONTROL_RESET_BIT         0  // Uno Analog Pin 0
   //XB #define CONTROL_FEED_HOLD_BIT     1  // Uno Analog Pin 1
   //XB #define CONTROL_CYCLE_START_BIT   2  // Uno Analog Pin 2
   //XB #define CONTROL_SAFETY_DOOR_BIT   1  // Uno Analog Pin 1 NOTE: Safety door is shared with feed hold. Enabled by config define.
  #define CONTROL_INT       PCIE1  // Pin change interrupt enable pin
  #define CONTROL_INT_vect  PCINT1_vect
  #define CONTROL_PCMSK     PCMSK1 // Pin change interrupt register
  #define CONTROL_MASK      ((1<<CONTROL_RESET_BIT)) //XB|(1<<CONTROL_FEED_HOLD_BIT)|(1<<CONTROL_CYCLE_START_BIT)|(1<<CONTROL_SAFETY_DOOR_BIT))
  #define CONTROL_INVERT_MASK   CONTROL_MASK // May be re-defined to only invert certain control pins.

  // Define probe switch input pin.
   //XB  #define PROBE_DDR       DDRC
  //XB   #define PROBE_PIN       PINC
  //XB   #define PROBE_PORT      PORTC
  //XB   #define PROBE_BIT       5  // Uno Analog Pin 5
   //XB  #define PROBE_MASK      (1<<PROBE_BIT)
