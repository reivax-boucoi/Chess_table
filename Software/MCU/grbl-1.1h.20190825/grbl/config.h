...
//XB #define HOMING_CYCLE_0 (1<<Z_AXIS)                // REQUIRED: First move Z to clear workspace.
//XB #define HOMING_CYCLE_1 ((1<<X_AXIS)|(1<<Y_AXIS))  // OPTIONAL: Then move X,Y at the same time.
// #define HOMING_CYCLE_2                         // OPTIONAL: Uncomment and add axes mask to enable

// NOTE: The following are two examples to setup homing for 2-axis machines.
// #define HOMING_CYCLE_0 ((1<<X_AXIS)|(1<<Y_AXIS))  // NOT COMPATIBLE WITH COREXY: Homes both X-Y in one cycle. 

#define HOMING_CYCLE_0 (1<<X_AXIS)  // COREXY COMPATIBLE: First home X //XB
 #define HOMING_CYCLE_1 (1<<Y_AXIS)  // COREXY COMPATIBLE: Then home Y //XB
...
#define COREXY // Default disabled. Uncomment to enable. //XB
...
#define REPORT_OVR_REFRESH_BUSY_COUNT 255//XB 20  // (1-255)
#define REPORT_OVR_REFRESH_IDLE_COUNT 255//XB 10  // (1-255) Must be less than or equal to the busy count
#define REPORT_WCO_REFRESH_BUSY_COUNT 255//XB 30  // (2-255)
#define REPORT_WCO_REFRESH_IDLE_COUNT 255//XB 10  // (2-255) Must be less than or equal to the busy count
